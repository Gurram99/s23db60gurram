...
router.get('/', function (req, res) {
  res.render('index', { title: 'Vechile App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'Vechile App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Vechile App Login', user: req.user });
});
